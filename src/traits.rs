...
/// Synced CmRDT
#[cfg(feature = "sync")]
pub trait SyncedCmRDT: CmRDT {
    /// Apply an Op to the CRDT in a thread-safe manner
    fn synced_apply(&self, op: Self::Op);
}

// #[cfg(feature = "sync")]
// impl<T: SyncedCmRDT> CmRDT for T {
//     type Op = T::Op;
//     type Validation = T::Validation;

//     fn validate_op(&self, op: &Self::Op) -> Result<(), Self::Validation> {
//         SyncedCmRDT::validate_op(self, op)
//     }

//     fn apply(&mut self, op: Self::Op) {
//         SyncedCmRDT::apply(&*self, op)
//     }
// }
